...
extern "C"
{
    ...
    void drawTriangle(GameEngine *instance, int32_t x1, int32_t y1, int32_t x2, int32_t y2, int32_t x3, int32_t y3, int32_t color)
    {
        instance->DrawTriangle(x1, y1, x2, y2, x3, y3, olc::Pixel(color));
    }

    void fillTriangle(GameEngine *instance, int32_t x1, int32_t y1, int32_t x2, int32_t y2, int32_t x3, int32_t y3, int32_t color)
    {
        instance->FillTriangle(x1, y1, x2, y2, x3, y3, olc::Pixel(color));
    }

    void fillTexturedTriangle(GameEngine *instance, const olc::vf2d *points, const olc::vf2d *texture, const olc::Pixel *colors, int32_t elements, olc::Sprite *sprite)
    {
        instance->FillTexturedTriangle(copyArray(points, elements), copyArray(texture, elements), copyArray(colors, elements), sprite);
    }

    void fillTexturedPolygon(GameEngine *instance, const olc::vf2d *points, const olc::vf2d *texture, const olc::Pixel *colors, int32_t elements, olc::Sprite *sprite, int32_t structure)
    {
        instance->FillTexturedPolygon(copyArray(points, elements), copyArray(texture, elements), copyArray(colors, elements), sprite, olc::DecalStructure(structure));
    }
    ...
    int32_t renderable_load(olc::Renderable *renderable, const char *path, olc::ResourcePack *pack, bool filter, bool clamp)
    {
    ...
    void drawPartialDecalSized(GameEngine *instance, const olc::vf2d pos, const olc::vf2d size, olc::Decal *decal, const olc::vf2d source_pos, const olc::vf2d source_size, const olc::Pixel tint)
    {
    ...
    void DrawPolygonDecal(GameEngine *instance, olc::Decal *decal, const olc::vf2d *pos, const olc::vf2d *uv, int32_t elements, const olc::Pixel tint)
    {
        instance->DrawPolygonDecal(decal, copyArray(pos, elements), copyArray(uv, elements), tint);
    }

    void DrawPolygonDecalWithDepth(GameEngine *instance, olc::Decal *decal, const olc::vf2d *pos, const float *depth, const olc::vf2d *uv, int32_t elements, const olc::Pixel tint)
    {
        instance->DrawPolygonDecal(decal, copyArray(pos, elements), copyArray(depth, elements), copyArray(uv, elements), tint);
    }

    void DrawPolygonDecalWithColors(GameEngine *instance, olc::Decal *decal, const olc::vf2d *pos, const olc::vf2d *uv, const olc::Pixel *tintColors, int32_t elements)
    {
        instance->DrawPolygonDecal(decal, copyArray(pos, elements), copyArray(uv, elements), copyArray(tintColors, elements));
    }

    void DrawPolygonDecalWithColorsAndTint(GameEngine *instance, olc::Decal *decal, const olc::vf2d *pos, const olc::vf2d *uv, const olc::Pixel *colours, int32_t elements, const olc::Pixel tint)
    {
        instance->DrawPolygonDecal(decal, copyArray(pos, elements), copyArray(uv, elements), copyArray(colours, elements), tint);
    }

    void DrawPolygonDecalWithDepthAndColorsAndTint(GameEngine *instance, olc::Decal *decal, const olc::vf2d *pos, const float *depth, const olc::vf2d *uv, const olc::Pixel *colours, int32_t elements, const olc::Pixel tint)
    {
        instance->DrawPolygonDecal(decal, copyArray(pos, elements), copyArray(depth, elements), copyArray(uv, elements), copyArray(colours, elements), tint);
    }
    ...
    int32_t getKeySymbol(char *buffer, int32_t bufferSize, GameEngine *instance, int32_t key, bool shift, bool ctrl, bool alt)
    {
    ...
    void HW3D_DrawObject(GameEngine *instance, const float *matModelView, olc::Decal *decal, int32_t layout, const float *positions, const float *uvs, const olc::Pixel *colors, int32_t elements, olc::Pixel tint)
    {
    ...
    void HW3D_DrawLine(GameEngine *instance, const float *matModelView, const float *pos1, const float *pos2, olc::Pixel color)
    {
        instance->HW3D_DrawLine(copyMatrix16(matModelView), copyArray4(pos1), copyArray4(pos2), color);
    }

    void HW3D_DrawLineBox(GameEngine *instance, const float *matModelView, const float *pos, const float *size, olc::Pixel color)
    {
